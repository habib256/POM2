# POM2 — Changelog archivé (2026-05-14 → 2026-05-30)

Entrées antérieures à la release v0.7 (2026-06-01), sorties du `CHANGELOG.md`
vivant pour l'alléger. Même contrat : capture les **« pourquoi »** et les pièges.
Le `git log` reste la source canonique. Changelog courant → [`../../CHANGELOG.md`](../../CHANGELOG.md).
