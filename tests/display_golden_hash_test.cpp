...
const std::map<std::string, uint64_t> kGolden = {
    ...
    { "iie/hgr/4bit", 0x4c02cfb4d8a2e2b1ULL },   // 4-bit artifact-phase fix (rotation absX)
    ...
    { "iie/hgrmixed/4bit", 0x88e5398a21d77486ULL },
    ...
    { "iie/dhgr/4bit", 0x50508d6ad2fccc3bULL },
    ...
    { "iie/dhgrmixed/4bit", 0xcd77d55ee0619577ULL },
    ...
    { "ii+/hgr/4bit", 0x4c02cfb4d8a2e2b1ULL },
