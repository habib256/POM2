...
| Run-control debugger (breakpoints, step, step-over, **write** watchpoints) | `Debugger.h/.cpp`, `Debugger_ImGui.*`, `MemoryWatchSink.h` | [§ Debugger](DEV.md#debugger-debuggerhcpp-debugger_imgui) |
